...
for unique_date in unique_dates:
   date_dict[unique_date] = int(client.count("date",unique_date)['playtime'])
...
plt.ylabel('total minutes of playtime')
plt.title('Total Playtime of Music Files By Year Of Release')
